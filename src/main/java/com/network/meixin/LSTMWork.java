...
public class LSTMWork {
    ...
    public static MultiLayerNetwork getNexModel(int nIn,int nOut){
        MultiLayerConfiguration conf=new NeuralNetConfiguration.Builder()
                ...
                .layer(2,new RnnOutputLayer.Builder(LossFunctions.LossFunction.MSE)
                        .activation("identity").nIn(lstmLayer2Size).nOut(nOut).build())
    ...
    public static void train(MultiLayerNetwork net,StockDataIterator iterator){
        ...
        for (int i = 0; i < Epochs; i++) {
            ...
            for (int j = 0; j < 20; j++) {
                ...
                System.out.println(output.getDouble(0)*iterator.getMaxArr()[1]+" ");
            }
    ...
    public static void main(String[] args){
        String inputFile="/Users/muller/Documents/githubDown/stockPredict/src/main/resource/sh000001.csv";//LSTMWork.class.getClassLoader().getResource("/Users/muller/Documents/githubDown/stockPredict/src/main/resource/sh000001.csv").getPath();
        int batchSize =1;
